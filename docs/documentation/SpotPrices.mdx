...
```bash
curl -X 'POST' \
  'https://api.sandbox.voluespark.com/api/spot-prices/NO1/advice' \
...
Below are examples on how the data might be visualized. These can also be viewed in [Storybook](https://thankful-sea-0ddc91f03.2.azurestaticapps.net/#tag/SpotPrice/operation/GetSpotPricesAdvice).
