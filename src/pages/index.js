        ...
        >
            <header className={style.header}>
                ...
                <p className={style.header_description}>
                    The SmartCharging API from Spark provides you with smart
                    charging recommendations that are optimized for cost and
                    efficiency. Independent of your customer's power supplier,
                    our API is also optimized for a week-long price forecast,
                    helping your customers save money on their EV charging. Our
                    API is designed to be flexible and easy to integrate into
                    your existing platform, making it easy for you to add value
                    to your EV charging services.
                </p>
                <Link
